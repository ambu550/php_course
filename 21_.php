<?php
/*
 * Отсортировать массивы: Имена в алфавитном порядке, в порядке убывания, а возраст в порядке возрастания
 */
...
echo ($spisok['roz1']['login']);
/*

var_dump(($spisok))
array_multisort($spisok[],  SORT_STRING);
var_dump(($spisok));
